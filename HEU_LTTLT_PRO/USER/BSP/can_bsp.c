  ...
  if((RxFifo0ITs & FDCAN_IT_RX_FIFO0_NEW_MESSAGE) != RESET)
  {
    if(hfdcan->Instance == FDCAN1)
    {
      ...
      HAL_FDCAN_GetRxMessage(hfdcan, FDCAN_RX_FIFO0, &RxHeader1, g_Can1RxData);
			...
			{//待重新配置id
		  case 1 :dm4310_data(&armmotor[0], g_Can1RxData,RxHeader1.DataLength);break;
      case 2 :dm4310_data(&armmotor[1], g_Can1RxData,RxHeader1.DataLength);break;
      case 3 :dm4310_data(&armmotor[2], g_Can1RxData,RxHeader1.DataLength);break;
      case 4 :dm4310_data(&armmotor[3], g_Can1RxData,RxHeader1.DataLength);break;
				default: break;
			}			
	  }
  }
